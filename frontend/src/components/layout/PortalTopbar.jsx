...
export default function PortalTopbar({ onMenuClick, title, settingsPath }) {
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="relative flex-1 max-w-sm hidden sm:block">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-sm focus:bg-white focus:border-blue-300 focus:ring-2 focus:ring-blue-100 outline-none transition"
          />
        </div>

        <span className="font-display font-bold text-slate-900 sm:hidden">{title}</span>
