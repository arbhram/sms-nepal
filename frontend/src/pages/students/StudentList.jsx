...
import { Plus, Search, Eye, Edit2, Trash2, Users, Download, KeyRound, Copy } from 'lucide-react';
...
export default function StudentList() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Students"
        subtitle={`${students.length} student${students.length !== 1 ? 's' : ''} in your institute`}
        action={
